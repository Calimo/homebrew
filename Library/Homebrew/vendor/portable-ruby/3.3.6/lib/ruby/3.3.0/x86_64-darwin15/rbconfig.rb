...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/3.3.0/x86_64-darwin15")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/usr/local/Cellar/portable-ruby/3.3.6")
  ...
  CONFIG["configure_args"] = " '--build=x86_64-apple-darwin21.6.0' '--host=x86_64-apple-darwin15.0.0' '--prefix=/usr/local/Cellar/portable-ruby/3.3.6' '--enable-load-relative' '--with-static-linked-ext' '--with-baseruby=/usr/local/Homebrew/Library/Homebrew/vendor/portable-ruby/3.3.5/bin/ruby' '--without-ext=win32,win32ole' '--without-gmp' '--disable-install-doc' '--disable-install-rdoc' '--disable-dependency-tracking' '--with-libyaml-dir=/usr/local/opt/portable-libyaml' 'build_alias=x86_64-apple-darwin21.6.0' 'host_alias=x86_64-apple-darwin15.0.0' 'CC=clang' 'CXX=clang++' 'LDFLAGS=-Wl,-search_paths_first'"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-search_paths_first -Wl,-multiply_defined,suppress -Wl,-undefined,dynamic_lookup"
  CONFIG["ALLOCA"] = ""
  ...
  CONFIG["LDFLAGS"] = "-L. -Wl,-search_paths_first -fstack-protector-strong"
  ...
  CONFIG["build_alias"] = "x86_64-apple-darwin21.6.0"
