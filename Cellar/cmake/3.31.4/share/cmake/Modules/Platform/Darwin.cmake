...
if(_CMAKE_OSX_SYSROOT_PATH)
  ...
  if(EXISTS ${_CMAKE_OSX_SYSROOT_PATH}/Users/calimo/brew/lib)
    list(INSERT CMAKE_PLATFORM_IMPLICIT_LINK_DIRECTORIES 0 ${_CMAKE_OSX_SYSROOT_PATH}/Users/calimo/brew/lib)
  endif()
endif()
...
if(_CMAKE_OSX_SYSROOT_PATH)
  ...
  if(EXISTS ${_CMAKE_OSX_SYSROOT_PATH}/Users/calimo/brew/include)
    list(INSERT CMAKE_SYSTEM_PREFIX_PATH 0 ${_CMAKE_OSX_SYSROOT_PATH}/Users/calimo/brew)
    foreach(lang C CXX OBJC OBJCXX Swift)
      list(APPEND _CMAKE_${lang}_IMPLICIT_INCLUDE_DIRECTORIES_INIT ${_CMAKE_OSX_SYSROOT_PATH}/Users/calimo/brew/include)
    endforeach()
  endif()
endif()
